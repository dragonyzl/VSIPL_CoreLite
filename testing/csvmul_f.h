/* $Id: csvmul.t,v 1.1 2000/04/02 20:29:58 judd Exp $ */
static void csvmul_f(){
   printf("********\nTEST csvmul_f\n");
   {
     ...
     vsip_scalar_f ans_r[] = { 34.3700, 39.9400, 30.4700, 42.1400, -45.4700, -4.1100 };
     vsip_scalar_f ans_i[] = { -2.6700, -5.6400, 59.7700, -4.1400, 4.7700, 4.6100 };
     ...
     printf("vsip_csvmul_f(alpha,b,c)\n");
     vsip_csvmul_f(alpha,b,c);
