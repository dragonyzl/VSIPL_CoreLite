/* $Id: cvjmul.t,v 1.1 2000/04/02 20:29:58 judd Exp $ */
static void cvjmul_f(){
   printf("********\nTEST cvjmul_f\n");
   {
     ...
     vsip_scalar_f ans_r[]    = { 28.12, 46.08, 71.82, 4.4, -16.0, -11.2 };
     vsip_scalar_f ans_i[]    = {-12.30, -23.60, 21.00, 49.28, 101.22, 9.18 };
