/* $Id: vexp.t,v 1.1 2000/04/02 20:29:58 judd Exp $ */
static void vexp_f(){
   printf("********\nTEST vexp_f\n");
   {
     vsip_scalar_f data[] = {-1, .25, 0,  2.5, -2 };
     vsip_scalar_f ans[]  = {0.3679, 1.284, 1.0, 12.1825, 0.1353 };
     ...
     printf("vsip_vexp(a,b) with <a> stride 2, <b> stride 1\n");
     vsip_vexp_f(b,a);
     vsip_vsub_f(a,ansv,chk); vsip_vmag_f(chk,chk); VU_limitIP_f(chk,.0001);
     if(vsip_vsumval_f(chk) > .5) 
         printf("error\n");
