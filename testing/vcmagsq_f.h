/* $Id: vcmagsq.t,v 1.1 2000/04/02 20:29:58 judd Exp $ */
static void vcmagsq_f(){
   printf("********\nTEST vcmagsq_f\n");
   {
     vsip_scalar_f data_a_i[] = { 1.1, -1.2, 2.1, 2.2, -3.1, -3.3};
     vsip_scalar_f data_a_r[] = { 2.1, -3.2, -2.1, -2.2, +5.1, +5.3};
     vsip_scalar_f ans[] = {  5.62, 11.68, 8.82, 9.68, 35.62, 38.98};
