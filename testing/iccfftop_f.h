...
**********************************************************************/
/* $Id: iccfftop.t,v 1.2 2000/04/12 20:46:12 judd Exp $ */

static void iccfftop_f()
{  
   printf("********\nTEST ccfftop inverse\n");
   {
      ...
      for(i=0; i<4; i++){
        printf("vsip_fft_f *fft = vsip_ccfftop_create_f(np,1.0,VSIP_FFT_INV,0,0)\n");
        printf("np = %4d\n",np[i]);
        ...
        { /* do fft */
          {
          vsip_fft_f *fft = vsip_ccfftop_create_f(np[i],1.0,VSIP_FFT_INV,0,0);
